      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="" href="{{route('institute.index') }} ">Add Institute</a></li>
              <li><a class="" href="{{ route('courses.index') }} ">Add Courses</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;" class="">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="" href="{{ route('feesmaster.index') }}">Add Fees</a></li>
